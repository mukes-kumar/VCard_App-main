  ...
  return (
    <>
      <div className='pb-0 pt-0 '>
        <div className='container w-[100%] pl-[40px] pr-[40px] mr-auto ml-auto'>
          <div className='mt-[-12rem] flex flex-wrap'>
            <div className='mb-[3rem] flex'>
              <a href="/dynamic" className='hover:mt-[-5px] delay-300 relative transition-all shadow-lg shadow-transparent flex flex-col min-w-0 bg-[#fff]  '>
                <div className=' pb-[3rem] px-[3rem] pt-[1.5rem]'>
                  ...
                  <h5 className='mb-[1rem] font-semibold text-lg text-[#2a354f] mt-0'>{DesName}</h5>
