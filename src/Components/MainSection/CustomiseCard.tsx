...
function CustomiseCard() {
  const productName = [
    { name: "Customized Mobile Pages", icon: "id-card" },
    { name: "Track QR Codes", icon: "bar-chart" },
    { name: "Choose Color & Shape", icon: "color-palette" },
    { name: "Add Logos to QR Codes", icon: "images" },
  ];
              ...
              <div key={name.name} className="p-9 shadow-sm  flex  justify-around items-center space-y-10 ">
                <div className='items-center '>
                  <div className='flex items-center justify-center'>
                    ...
                    <ion-icon name={`${name.icon}`}></ion-icon>
                    </span>
                  </div>
